...
<div class="wrapper" id="app">
    ...
    <header class="main-header">
        ...
        <a href="#" class="logo">
            ...
            <span class="logo-mini"><b>jsp数据</b></span>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr v-for="u in userList">
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn bg-olive btn-xs" @click="findByIdforfind(u.id)">详情</button>
                                    <button type="button" class="btn bg-olive btn-xs" @click="findByIdforupdate(u.id)">编辑</button>
                                </td>
                            </tr>
                                                ...
                                                <div class="box-body">
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <input type="text" class="form-control" value="" v-model="user.username">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">密码:</label>
                                                            <div class="col-sm-5">
                                                                <input type="text" class="form-control" value="" v-model="user.password">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">性别:</label>
                                                            <div class="col-sm-5">
                                                                <input type="text" class="form-control" value="" v-model="user.sex">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">年龄:</label>
                                                            <div class="col-sm-5">
                                                                <input type="text" class="form-control" value="" v-model="user.age">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label">邮箱:</label>
                                                            <div class="col-sm-5">
                                                                <input type="text" class="form-control" value="" v-model="user.email">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<script src="<%=path%>/js/vuejs-2.5.16.js"></script>
<script src="<%=path%>/js/axios-0.18.0.js"></script>
